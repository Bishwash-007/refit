...
const Hero = () => {
  return (
    <section
      id="hero"
      className="flex h-screen w-full items-center bg-dark px-32"
    >
      <div className="flex w-1/2 flex-col items-start gap-8 text-start">
        <div>
          <div className="inline-flex items-center gap-3 rounded-full bg-mid px-4 py-2">
            ...
            <p className="p-notification-badge">Available for work</p>
          </div>
        ...
        <div>
          ...
          >
            <span className="ml-2 p-button-text">Work with us</span>
